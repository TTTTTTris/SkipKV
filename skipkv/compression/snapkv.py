...
class SnapKV:
    ...
    def update_kv(
        ...
        if kv_cache_len < self.budget:
            ...
            # print(attn_weights.shape, attn_weights_sum.shape) # torch.Size([1, 8, 1, 248]) torch.Size([1, 8, 247])
            ...
            if self.record_kept_token_indices:
                ...
                # print(indices_cl.shape, recent_window_indices.shape) # torch.Size([8, 120]) torch.Size([8, 8])
            ...
            # print(indices.shape) # torch.Size([1, 8, 127])
            ...
            # print(k_past_compress.shape, k_cur.shape) # torch.Size([1, 8, 127, 128]) torch.Size([1, 8, 1, 128])
